...
static u_char ngx_rtmp_mpegts_header[] = {
    ...
    //0xc7, 0x72, 0xb7, 0xcb, // crc for h265
    /* stuffing 157 bytes */
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
/*
 * rewrite continuity_counter field in PAT/PMT table.
 */
ngx_int_t
ngx_rtmp_mpegts_write_header(ngx_file_t *file, ngx_uint_t psi_cc, ngx_int_t is_hevc)
{
    ssize_t rc;
    static u_char h265_crc[4] = { 0xc7, 0x72, 0xb7, 0xcb};
    static u_char h264_crc[4] = { 0x2f, 0x44, 0xb9, 0x9b};
    ...
    if (is_hevc) {
        ngx_rtmp_mpegts_header[3+188+14] = 0x24;
        ngx_rtmp_mpegts_header[3+188+14+10] = h265_crc[0];
        ngx_rtmp_mpegts_header[3+188+14+11] = h265_crc[1];
        ngx_rtmp_mpegts_header[3+188+14+12] = h265_crc[2];
        ngx_rtmp_mpegts_header[3+188+14+13] = h265_crc[3];
    } else {
        ngx_rtmp_mpegts_header[3+188+14] = 0x1b;
        ngx_rtmp_mpegts_header[3+188+14+10] = h264_crc[0];
        ngx_rtmp_mpegts_header[3+188+14+11] = h264_crc[1];
        ngx_rtmp_mpegts_header[3+188+14+12] = h264_crc[2];
        ngx_rtmp_mpegts_header[3+188+14+13] = h264_crc[3];
    }
